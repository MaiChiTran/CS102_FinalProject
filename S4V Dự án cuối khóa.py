...
def draw_timer():
    ...
    pen_timer.clear()
    # Đổi màu.
    pen_timer.color('white')
    # Đặt vị trí.
    pen_timer.setposition(-275, 170)
...
def get_font(font_size):
    return ("Consolas", font_size, "normal")
...
def draw_score():
    ...
    # Đặt vị trí.
    pen_score.setposition(420, 200)
    # Viết điểm số ra màn hình.
    pen_score.write(state.score, font=get_font(25))
